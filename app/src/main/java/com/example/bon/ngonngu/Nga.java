...
public class Nga extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView =findViewById(R.id.recycler_view_nga);
        ...
        //
        adapter =new MainAdapter1(this,databaseHelper.getArray());
        //
        ...
        btAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Dialog dialog = new Dialog(Nga.this);
                //
